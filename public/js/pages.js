...
/* harmony export */ });
/* harmony import */ var _views_load_browser_views_mjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../views/load-browser-views.mjs */ "./views/load-browser-views.mjs");
/* harmony import */ var _webhandle_record_table__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @webhandle/record-table */ "./node_modules/@webhandle/record-table/client-lib/record-table.mjs");
/* harmony import */ var _setup_data_service_mjs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./setup-data-service.mjs */ "./client-lib/setup-data-service.mjs");
/* harmony import */ var _client_lib_all_data_view_mjs__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../client-lib/all-data-view.mjs */ "./client-lib/all-data-view.mjs");
...
function integrate() {
	if (!dataService) {
		dataService = (0,_setup_data_service_mjs__WEBPACK_IMPORTED_MODULE_2__["default"])()
		...
		if (frame) {
			...
			let one = new _client_lib_all_data_view_mjs__WEBPACK_IMPORTED_MODULE_3__["default"]({
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   allDataViewFrame: () => (/* reexport default export from named module */ _url_request_all_data_view_all_data_view_frame_tri__WEBPACK_IMPORTED_MODULE_0__),
/* harmony export */   byResourceSection: () => (/* reexport default export from named module */ _url_request_all_data_view_by_resource_section_tri__WEBPACK_IMPORTED_MODULE_5__),
/* harmony export */   byResourceUserRow: () => (/* reexport default export from named module */ _url_request_all_data_view_by_resource_user_row_tri__WEBPACK_IMPORTED_MODULE_6__),
/* harmony export */   byResourcesTable: () => (/* reexport default export from named module */ _url_request_all_data_view_by_resources_table_tri__WEBPACK_IMPORTED_MODULE_4__),
/* harmony export */   byUsersResourceRow: () => (/* reexport default export from named module */ _url_request_all_data_view_by_users_resource_row_tri__WEBPACK_IMPORTED_MODULE_3__),
/* harmony export */   byUsersSection: () => (/* reexport default export from named module */ _url_request_all_data_view_by_users_section_tri__WEBPACK_IMPORTED_MODULE_2__),
/* harmony export */   byUsersTable: () => (/* reexport default export from named module */ _url_request_all_data_view_by_users_table_tri__WEBPACK_IMPORTED_MODULE_1__)
/* harmony export */ });
/* harmony import */ var _url_request_all_data_view_all_data_view_frame_tri__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./url-request/all-data-view/all-data-view-frame.tri */ "./views/url-request/all-data-view/all-data-view-frame.tri");
/* harmony import */ var _url_request_all_data_view_by_users_table_tri__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./url-request/all-data-view/by-users-table.tri */ "./views/url-request/all-data-view/by-users-table.tri");
/* harmony import */ var _url_request_all_data_view_by_users_section_tri__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./url-request/all-data-view/by-users-section.tri */ "./views/url-request/all-data-view/by-users-section.tri");
/* harmony import */ var _url_request_all_data_view_by_users_resource_row_tri__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./url-request/all-data-view/by-users-resource-row.tri */ "./views/url-request/all-data-view/by-users-resource-row.tri");
/* harmony import */ var _url_request_all_data_view_by_resources_table_tri__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./url-request/all-data-view/by-resources-table.tri */ "./views/url-request/all-data-view/by-resources-table.tri");
/* harmony import */ var _url_request_all_data_view_by_resource_section_tri__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./url-request/all-data-view/by-resource-section.tri */ "./views/url-request/all-data-view/by-resource-section.tri");
/* harmony import */ var _url_request_all_data_view_by_resource_user_row_tri__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./url-request/all-data-view/by-resource-user-row.tri */ "./views/url-request/all-data-view/by-resource-user-row.tri");
